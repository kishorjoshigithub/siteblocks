            ...
            <div className="flex flex-wrap gap-3.5">
              {projects.map((project) => (
                <div
                  ...
                  className="relative group w-72 rounded max-sm:mx-auto cursor-pointer bg-gray-900/60 border hover:shadow-indigo-700/30 hover:border-indigo-800/80 transition-all duration-300"
                  key={project.id}
                >
                  <div
                  ...
                  <div onClick={(e) => e.stopPropagation()} className="">
                    <TrashIcon
                      color="red"
                      className="absolute top-3 right-3 scale-0 group-hover:scale-100 bg-white p-1.5 size-7 transition-all rounded-md "
