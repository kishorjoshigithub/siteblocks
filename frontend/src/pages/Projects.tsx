        ...
        <div className="flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar">
          ...
          <div className="flex items-center gap-2 sm:min-w-90 text-nowrap">
            ...
            <div className="max-w-64 sm:max-w-xs">
              ...
              <p className="text-xs to-gray-400 -mt-0.5">
          ...
          <div className="flex items-center justify-end gap-3 flex-1 text-xs sm:text-sm">
            <button
              onClick={saveProject}
              disabled={isSaving}
              className="max-sm:hidden bg-gray800 hover:bg-gray-700 text-white px-3.5 py-1 flex items-center gap-2 rounded sm:rounded-md transition-colors border border-gray-700"
            >
              {isSaving ? (
