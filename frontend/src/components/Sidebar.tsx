  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        {/* Message  */}
        <div className="flex-1 no-scrollbar overflow-y-auto px-3 flex flex-col gap-4">
            ...
            .map((message) => {
              ...
              if (isMessage) {
                ...
                return (
                  ...
                  >
                    {!isUser && (
                      <div className="w-8 h-8 rounded-full bg-linearto from-indigo-600 to-indigo-700 flex items-center justify-center">
                        <BotIcon className="text-white size-5" />
                      </div>
                    )}

                    <div
                      className={`max-w-[80%] p-2 px-4 rounded-2xl shadow-sm text-sm mt-4 leading-relaxed ${
                        isUser
                ...
                // Render version info here
                const ver = message as Version;
                return (
                  <div
                    key={ver.id}
                    className="w-4/5 mx-auto my-2 p-3 rounded-xl bg-gray-800 textgray100 shadow flex flex-col gap-2"
                  >
